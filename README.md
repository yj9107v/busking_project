...
### 🙊 신동진 - 백엔드
- **GitHub / Email:** `tlsehdwls201@naver.com`
- **역할:** 🔐 로그인/회원가입, 👤 회원 관련 기능 구현
- **후기:** `작성 예정`

### 🍇 최용준 - 백엔드
- **GitHub / Email:** `yj9107vv@gmail.com`
- **역할:** 📐 ERD 설계, 📚 기능 구조화, 📄 API 명세서 작성, 🧪 User 테스트코드 작성
- **후기:** `작성 예정`

### 🐶 유승범 - 백엔드/프론트엔드
- **GitHub / Email:** `ysb7021@naver.com`
- **역할:** 📝 게시판 구현 및 🗺️ 카카오맵 연동, 📄 API 명세서 작성, 🧪 PromotionPost 테스트코드 작성
- **후기:** `작성 예정`
